...
from MSP.model import set_seed
...
logging.basicConfig(level=logging.INFO,  # 设置日志级别
                    ...
                    handlers=[
                        logging.FileHandler("ten_fold_classification.log"),  # 日志文件
        ...
        for epoch in range(NUM_EPOCHS):
            ...
            if auc > max_metrix:
                ...
                torch.save(model.state_dict(),
                           r"E:\ProgrammingSpace\Gitee\MSP\MSP\data\stratified_kfold_splits\test_fold_{}.pt".format(i))
