...
"""
“w/o GCL”表示删除图形对比学习模块，然后删除原始图形编码模块，只留下键合图编码模块用于分子稳定性预测。“w/o BG”设置意味着使用原始分子图而不是键合图来预测分子代谢稳定性，同时在整个训练过程中保留图对比学习和键合图编码模块。A.
"""
...
logging.basicConfig(level=logging.INFO,  # 设置日志级别
                    ...
                    handlers=[
                        logging.FileHandler("ablation_cls_wo_MGTR.log"),  # 日志文件
