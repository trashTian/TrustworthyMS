...
logging.basicConfig(level=logging.INFO,  # 设置日志级别
                    ...
                    handlers=[
                        logging.FileHandler("parameter_cl.log"),  # 日志文件
    ...
    for t in temperature:
        ...
        for i in range(1, 11):
            ...
            for epoch in range(NUM_EPOCHS):
                train_labels, train_probs, lossz = train_epoch(model, device, batches_train1, optimizer, criterion, t)
                ...
                if auc > max_metrix:
                    max_metrix = auc
                    temp_best = [auc, acc, f1, mcc]
            best_results.append(temp_best)
            logging.info('fold: {} {}'.format(i, str(temp_best)))

        np.save('t={}.npy'.format(t), np.array(best_results))
